...
namespace AdministracionAngela.ProyectoAngela.Formularios
{
    public partial class ReportViewerListadoClientes : Form
    {
        ...
        {
            this.AltaClienteViewModelBindingSource.DataSource = clientes.OrderBy(x=> x.CodigoCliente) ;
            ...
            var test = Task.Factory.StartNew(() =>
            {
                ...
                var exportPath = string.Format(@"{0}\Listado Clientes.pdf", RutasSalida.RutaListados);
